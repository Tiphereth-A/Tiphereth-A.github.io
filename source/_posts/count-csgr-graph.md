...
{% note warning %}
<https://cplib.tifa-233.com/src/graph/cnt/ring3/lib.hpp> 存放了笔者对该算法/数据结构的最新实现, 建议前往此处查看相关代码
{% endnote %}
...
{% note warning %}
<https://cplib.tifa-233.com/src/graph/cnt/ring4/lib.hpp> 存放了笔者对该算法/数据结构的最新实现, 建议前往此处查看相关代码
{% endnote %}
