...
**<a id="th-2-1">定理 - 2-1</a>** (Jordan-von Neumann 定理) 在完备的赋范线性空间[^3] $(V,\lVert\cdot\rVert)$ 中, 若可在 $V$ 上引入内积 $(\cdot,\cdot)$ 满足对任意 $x\in V$ 均有 $(x,x)^{\frac{1}{2}}=\lVert x\rVert$, 范数 $\lVert\cdot\rVert$ 必须且仅须满
足如下的平行四边形等式:
