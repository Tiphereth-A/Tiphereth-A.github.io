...
**<a id="def-1-1">定义 - 1-1</a>** 对线性空间 $(V,\Bbb{P},+,\cdot)$,
...
**<a id="pb-1-1">性质 - 1-1</a>** 对线性空间 $(V,\Bbb{P},+,\cdot)$,
...
**<a id="def-1-2">定义 - 1-2</a>** 对线性空间 $(V,\Bbb{P},+,\cdot)$,
...
**<a id="pb-1-2">性质 - 1-2</a>** 对线性空间 $(V,\Bbb{P},+,\cdot)$,
...
**<a id="def-2-1">定义 - 2-1</a>** (Hamel 基) 称线性空间 $(V,\Bbb{P},+,\cdot)$ 的极大线性无关组为 $V$ 的一组 **Hamel 基** 或 **线性基**, 简称 **基**
...
若限定向量均在 $\Z_2^n$ 下, 则称找到的基为 **异或线性基**

若限定向量均在 $\R^n$ 下, 则称找到的基为 **实数线性基**
