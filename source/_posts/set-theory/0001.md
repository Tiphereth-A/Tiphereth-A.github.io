...
$$D=\bigcup_{k=1}^{\infty}\bigcap_{N=1}^{\infty}\bigcup_{n=N}^{\infty}\left\{x:|f_n(x)-f(x)|\geqslant{1\over k}\right\}$$
...
$$\exist k\in\N^+,\forall N\in\N^+,\exist n\geqslant N,~s.t.~|f_n(x_0)-f(x_0)|\geqslant{1\over k}$$

令 $E_{n,k}=\left\{x:|f_n(x)-f(x)|\geqslant{1\over k}\right\}$, 则
$$\exist k\in\N^+,x_0\in\limsup_{n\to\infty}E_{n,k}$$
反之, $\forall k\in\N^+,x\in\limsup_{n\to\infty}E_{n,k}$ 显然不是收敛点

从而
$$x_0\in\bigcup_{k=1}^{\infty}\limsup_{n\to\infty}E_{n,k}=\bigcup_{k=1}^{\infty}\bigcap_{N=1}^{\infty}\bigcup_{n=N}^{\infty}\left\{x:|f_n(x)-f(x)|\geqslant{1\over k}\right\}=D$$
...
证明:
$$\forall t\in\Reals,\{x:f(x)\leqslant t\}=\bigcap_{k=1}^{\infty}\bigcup_{N=1}^{\infty}\bigcap_{n=N}^{\infty}\left\{x:f_n(x)<t+{1\over k}\right\}$$
...
令 $E_{n,k}=\left\{x:f_n(x)<t+{1\over k}\right\}$, 则

$$\begin{aligned}
  x_0\in\{x:f(x)\leqslant t\}\iff&\lim_{n\to\infty}f_n(x_0)=f(x_0)\leqslant t\\
  \iff&\forall k\in\N^+,\exist N\in\N^+,\forall n\geqslant N,~f_n(x_0)<t+{1\over k}\\
  \iff&\forall k\in\N^+,x_0\in\liminf_{n\to\infty}E_{n,k}\\
  \iff&x_0\in\bigcap_{k=1}^{\infty}\liminf_{n\to\infty}E_{n,k}=\bigcap_{k=1}^{\infty}\bigcup_{N=1}^{\infty}\bigcap_{n=N}^{\infty}\left\{x:f_n(x)<t+{1\over k}\right\}
\end{aligned}$$
...
证明:
$$\bigcap_{k=1}^{\infty}\bigcup_{N=1}^{\infty}\bigcap_{n=N}^{\infty}\left(a_n-{1\over k},a_n+{1\over k}\right)=a$$
...
令 $E_{n,k}=\left(a_n-{1\over k},a_n+{1\over k}\right)$, 则

$$\begin{aligned}
  a_0\in\bigcap_{k=1}^{\infty}\bigcup_{N=1}^{\infty}\bigcap_{n=N}^{\infty}\left(a_n-{1\over k},a_n+{1\over k}\right)=\bigcap_{k=1}^{\infty}\liminf_{n\to\infty}E_{n,k}
