...
\begin{scope}[xshift=4cm, yshift=1cm, scale=0.9,y={(0.2cm,0.3cm)},x={(1cm,0cm)}, z={(0cm,1cm)}]
	...
	\draw[thin, dotted, hidden] (1,1,-1)--(-1,1,-1)--(-1,-1,-1);
	\draw[thin, dotted, hidden] (-1,1,-1)--(-1,1,1);
  ...
  \begin{scope}[scale=1.2,xshift=6.3cm,yshift=0.8cm,y={(0.2cm,0.3cm)},x={(1cm,0cm)}, z={(0cm,1cm)}]
	...
	\draw[thin, dotted, hidden] (1,0,0)--(0,1,0)--(-1,0,0);
	\draw[thin, dotted, hidden] (0,0,1)--(0,1,0)--(0,0,-1);
...
\node[inner sep = 0cm,xshift=7.6cm] at (0,-1)   () {Octahedron};
  ...
  \begin{scope}[xshift=11.2cm,yshift=1cm,scale=0.7,y={(0.15cm,0.3cm)},x={(1cm,0cm)}, z={(0cm,1cm)}]
	...
	\draw[thin, dotted, hidden] (-1,1,1)--(-\rg,\gr,0)--(\rg,\gr,0)--(1,1,1);
	\draw[thin, dotted, hidden] (-\rg,\gr,0)--(-1,1,-1)--(-\gr,0,-\rg);
	\draw[thin, dotted, hidden] (0,-\rg,-\gr)--(0,\rg,-\gr)--(-1,1,-1);
	\draw[thin, dotted, hidden] (0,\rg,-\gr)--(1,1,-1)--(\gr,0,-\rg);
	\draw[thin, dotted, hidden] (1,1,-1)--(\rg,\gr,0);
  \end{scope}
\node[inner sep = 0cm,xshift=11.2cm] at (0,-1)   () {Dodecahedron};
  ...
  \begin{scope}[xshift=15cm,yshift=1cm,scale=0.7,y={(0.1cm,0.3cm)},x={(1cm,0cm)}, z={(0cm,1cm)}]
	...
	\draw[thin, dotted, hidden] (0,-1,\gr)--(-\gr,0,1)--(-1,-\gr,0)--(-\gr,0,-1) ;
	\draw[thin, dotted, hidden] (\gr,0,1) --(0,-1,\gr)--(0,1,\gr);
	\draw[thin, dotted, hidden] (\gr,0,-1)--(1,-\gr,0)--(0,-1,-\gr);
	\draw[thin, dotted, hidden] (1,-\gr,0)--(-1,-\gr,0)--(0,-1,-\gr);
	\draw[thin, dotted, hidden] (1,-\gr,0) --(\gr,0,1);
	\draw[thin, dotted, hidden] (1,-\gr,0)--(0,-1,\gr)--(-1,-\gr,0);
